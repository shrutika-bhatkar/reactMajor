        ...
        return ( 
            <div>
                <Navbar className={classnames("navbar", {
                  ...
                  })} bg="purple" text="white" var expand="lg">
                <Navbar.Brand style={{color:"white"}}>Lifescape Hospital Ltd</Navbar.Brand>
                <Navbar.Toggle aria-controls="basic-navbar-nav" />
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="ml-auto">
                      {/* <Link to="/about">About</Link> */}
                    <Nav.Link className="text-white" href="/PatHome">Home</Nav.Link>
                    <Nav.Link className="text-white" href="/PatientAbout">About</Nav.Link>                    
                    <Nav.Link className="text-white" href="/PatientGallery">Gallery</Nav.Link>
                    <Nav.Link className="text-white" href="/PatientContact">Contact Us</Nav.Link>
