        ...
        return ( 
            <div>
                <Navbar className={classnames("navbar", {
                  ...
                  })} bg="gray-dark" text="white" var expand="lg">
                <Navbar.Brand style={{color:"white"}}>Lifescape Hospital Ltd</Navbar.Brand>
                <Navbar.Toggle aria-controls="basic-navbar-nav" />
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="ml-auto">
                      {/* <Link to="/about">About</Link> */}
                    <Nav.Link className="text-white" href="/AdHome">AHome</Nav.Link>
                    <Nav.Link className="text-white" href="/AdminAbout">About</Nav.Link>                    
                    <Nav.Link className="text-white" href="/AdminGallery">Gallery</Nav.Link>
                    <Nav.Link className="text-white" href="/AdminContact">Contact Us</Nav.Link>
                    
                    {/* <Nav.Link className="text-white" href="/DoctorReg">Add Doctor </Nav.Link> */}
